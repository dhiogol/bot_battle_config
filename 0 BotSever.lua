...
if rootWidget then
  ...
  botServerWindow.Features.Feature3:setOn(storage[BotPanelName].pushTile)
  botServerWindow.Features.Feature3.onClick = function(widget)
    storage[BotPanelName].pushTile = not storage[BotPanelName].pushTile
    widget:setOn(storage[BotPanelName].pushTile)
  end
end
